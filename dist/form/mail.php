...
$subject = "FREEWEBHOPEのLPから資料請求がありました";
...
$require = array('法人名','担当者様氏名','電話番号','メールアドレス');
...
$refrom_name = "株式会社FREEWEBHOPE";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "FREEWEBHOPEの資料をご請求いただきありがとうございます";
...
FREEWEBHOPEの資料をご請求いただきありがとうございます。
